...
--TRIGGER: trigger para colocar data de conclusão em um exercicio
...
-- PROCEDURE: inserir valores no histórico de meditação(toda vez que um usuário acessar uma meditação)
